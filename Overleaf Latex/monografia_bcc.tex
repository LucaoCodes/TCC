...
\end{tabular}
\caption{Comparativo de métricas de avaliação dos modelos estimados}\label{tab:metricas}
\end{table}

Essas falhas nos pressupostos do MQO justificam o avanço para modelos mais sofisticados, como os Generalized Additive Models (GAM), que serão empregados na próxima fase.
