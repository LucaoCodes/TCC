...
A robustez das métricas obtidas nesse split único foi também investigada por meio de \textit{walk-forward cross-validation} com janela expansiva (seis dobras, testes de dois anos cada, cobrindo 2010--2021). Os resultados revelaram que o desempenho dos modelos é sensível ao regime econômico: o desvio padrão do R² do GAM entre as dobras foi de 0{,}086 --- acima do limiar de estabilidade adotado como critério de adoção (0{,}05) ---, indicando que a relação entre variáveis macroeconômicas e retornos do Ibovespa varia substancialmente entre períodos de alta e baixa volatilidade. Notavelmente, o fold correspondente ao período COVID (2020--2021) apresentou o maior R² de todas as dobras (0{,}378 para o GAM), enquanto os períodos de menor volatilidade (2012--2015) produziram os menores (0{,}16--0{,}19). O ranking entre modelos --- GAM $>$ OLS $>$ BSTS --- manteve-se estável nas seis dobras, confirmando a conclusão principal do trabalho. A documentação completa desse experimento, incluindo resultados por fold e análise de regime, está disponível no arquivo \texttt{walk\_forward\_cv\_report.md} e no branch \texttt{exp/walk-forward-cv} do repositório.
