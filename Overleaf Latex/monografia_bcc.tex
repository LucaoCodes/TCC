...
Primeiro, a quantificação probabilística da incerteza. O BSTS produz, para cada previsão, um intervalo de credibilidade derivado diretamente da posteriori bayesiana. Isso é particularmente útil em contextos de decisão sob risco, em que conhecer a faixa plausível de variação importa tanto quanto a previsão pontual. Modelos como GAM e OLS, embora forneçam intervalos de confiança nos coeficientes, não produzem nativamente intervalos de credibilidade dinâmicos sobre as previsões.
...
Em síntese, GAM e BSTS são complementares mais do que substitutos: o GAM é superior em previsão pontual e na visualização de não linearidades, enquanto o BSTS adiciona estrutura temporal explícita, intervalos de credibilidade e decomposição. Essa complementaridade reforça o argumento, central neste trabalho, de que a escolha do modelo deve ser orientada não apenas pela métrica preditiva, mas também pela natureza da pergunta e pela robustez interpretativa exigida pelo problema.
